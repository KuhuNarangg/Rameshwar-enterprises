...
const FlowNode = ({ icon: Icon, title, desc, step, isLast }) => (
    <div className="relative flex flex-col items-center text-center group">
        <div className="w-20 h-20 bg-slate-800 rounded-2xl shadow-xl flex items-center justify-center mb-6 relative z-10 border border-slate-700 group-hover:border-emerald-500 transition-colors duration-300">
            <Icon size={32} className="text-emerald-400" />
            <div className="absolute -top-3 -right-3 w-8 h-8 bg-emerald-500 rounded-full flex items-center justify-center text-white text-xs font-bold border-4 border-slate-900">
                {step}
            </div>
        </div>
        ...
        {!isLast && (
            <div className="hidden md:block absolute top-10 left-[60%] w-[calc(100%-40px)] h-[2px] bg-slate-700">
        ...
        {!isLast && (
            <div className="md:hidden my-4 text-slate-600">
                <ArrowDown size={24} />
            </div>
        )}
    </div>
    ...
    return (
        <section id="why-us" className="py-24 bg-slate-900 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none opacity-20">
                <div className="absolute top-[20%] right-[10%] w-[400px] h-[400px] bg-emerald-500 rounded-full blur-[100px]" />
                <div className="absolute bottom-[10%] left-[5%] w-[300px] h-[300px] bg-blue-500 rounded-full blur-[80px]" />
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="text-center mb-20">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-800 shadow-sm text-emerald-400 text-[10px] font-black uppercase tracking-[0.2em] mb-6 border border-slate-700"
                    >
                        <Database size={12} className="fill-emerald-500" />
                    ...
                    >
                        Why Choose <span className="text-emerald-500">Rameshwar?</span>
                    </motion.h2>
                    <motion.p
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {[
                        ...
                        <motion.div
                            ...
                            className="bg-slate-800/50 backdrop-blur-sm p-8 rounded-[2rem] shadow-lg border border-slate-700 hover:border-emerald-500/50 transition-colors group"
                        >
