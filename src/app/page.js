...
export default function Home() {
  return (
    <div className="bg-white">
      ...
      <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-emerald-950">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-emerald-100 mb-12 max-w-3xl mx-auto font-light leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              ...
              <Link href="/contact" className="px-10 py-5 rounded-2xl font-bold text-lg border-2 border-emerald-400/30 hover:bg-emerald-400/10 text-white transition-all backdrop-blur-sm">
                Get a Quote
              </Link>
            </div>
          </motion.div>
      ...
      <section className="py-24 bg-emerald-50 relative overflow-hidden text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="mb-16">
            <h2 className="text-4xl font-black text-emerald-950 mb-6">Why Choose Rameshwar?</h2>
            <p className="text-emerald-800/80 max-w-2xl mx-auto">Industry-leading technology designed for maximum yield and minimal downtime.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {[
              ...
              <div key={i} className="bg-white p-8 rounded-2xl border border-emerald-100 hover:border-emerald-500/50 transition-all shadow-sm hover:shadow-lg">
          ...
          <Link href="/why-us" className="inline-flex items-center gap-2 text-emerald-600 font-bold uppercase tracking-widest hover:text-emerald-500 transition-colors">
      ...
      <section className="py-24 bg-white relative text-center md:text-left">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 md:order-2">
              ...
              <h2 className="text-4xl md:text-5xl font-black text-emerald-950 mb-6">Model R-24 <br /><span className="text-emerald-600">Automated Plant</span></h2>
              ...
              <ul className="space-y-4 mb-10 text-emerald-700">
                <li className="flex items-center gap-3"><Leaf size={16} className="text-emerald-500" /> 50KL / 100KL Daily Capacity</li>
                <li className="flex items-center gap-3"><Leaf size={16} className="text-emerald-500" /> PLC Controlled Operation</li>
                <li className="flex items-center gap-3"><Leaf size={16} className="text-emerald-500" /> B100 Standard Output</li>
              </ul>
              <Link href="/products" className="bg-emerald-950 text-white px-8 py-4 rounded-xl font-bold uppercase tracking-widest text-sm hover:bg-emerald-800 hover:text-white transition-all shadow-lg">
      ...
      <section className="py-24 bg-emerald-950 relative overflow-hidden text-center border-t border-emerald-900">
        <div className="max-w-4xl mx-auto px-4 relative z-10">
          <h2 className="text-4xl md:text-5xl font-black text-white mb-8">Ready to Start Your Project?</h2>
          <p className="text-emerald-200/60 text-xl mb-12">Get in touch with our engineering team for a free consultation and quote.</p>

          <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-12">
            <div className="flex items-center gap-3 text-white">
              <Phone className="text-emerald-500" /> +91 90535 71119
            </div>
            <div className="flex items-center gap-3 text-white">
              <Mail className="text-emerald-500" /> sohamdang0@gmail.com
            </div>
            <div className="flex items-center gap-3 text-white">
              <MapPin className="text-emerald-500" /> Rohtak, Haryana
            </div>
          </div>

          <Link href="/contact" className="inline-block bg-white text-emerald-950 px-10 py-5 rounded-2xl font-black uppercase tracking-widest text-sm hover:bg-emerald-50 transition-all shadow-2xl scale-100 hover:scale-105">
            Contact Us Now
          </Link>
        </div>
      </section>
